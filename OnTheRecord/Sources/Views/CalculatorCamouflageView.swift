...
struct CalculatorCamouflageView: View {
    ...
    @Binding var isDuressActive: Bool
    ...
    private func calculateResult() {
        ...
        if let duressPIN = duressPIN, (enteredSequence == duressPIN || displayText == duressPIN) {
...
#Preview {
    CalculatorCamouflageView(isUnlocked: .constant(false), isDuressActive: .constant(false))
}
